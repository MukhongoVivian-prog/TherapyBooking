    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rescheduled_from', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Session.appointment')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Session.patient')),
                ('therapist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Session.therapist')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('appointment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Session.appointment')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Session.patient')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Session.therapist'),
        ),
        migrations.CreateModel(
            name='Availability',
            fields=[
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='therapist', to='Session.user'),
        ),
        migrations.AddField(
            model_name='patient',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='patient', to='Session.user'),
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Session.user')),
            ],
        ),
    ]
